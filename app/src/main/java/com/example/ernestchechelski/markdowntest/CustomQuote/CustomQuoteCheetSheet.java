...
public class CustomQuoteCheetSheet {
    public static class CustomQuoteShortcut {
        ...
        public CustomQuoteShortcut(String name, String image, String url) {
            this.name = name;
            this.image = image;
            this.url = url;
        }
    ...
    static {
        shortCutMap.put("smile", new CustomQuoteShortcut("smile", "smile.png", "https://assets-cdn.github.com/images/icons/emoji/unicode/1f604.png"));
    }

    public static void wantFileUrlMaps() {
        synchronized (fileMap) {
            if (fileMap.isEmpty()) {
                // create a file map to CustomQuoteShortcut
