...
import com.example.ernestchechelski.markdowntest.dummy.DummyContent;
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putLong(NoteDetailFragment.ARG_ITEM_ID,holder.mItem.getId());
                        ...
                        intent.putExtra(NoteDetailFragment.ARG_ITEM_ID, holder.mItem.getId());
